...
LOCAL os_timer_t gas_detect_timer;
...
platform_init(void)
{
	...
	os_timer_disarm(&gas_detect_timer);
	os_timer_setfn(&gas_detect_timer,(os_timer_func_t *)gas_detect_start,(void *)0);
	os_timer_arm(&gas_detect_timer,1000,1);
